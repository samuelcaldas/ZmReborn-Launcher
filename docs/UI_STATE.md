...
This document describes current working-tree behavior for ZM Reborn 3.1.11-alpha-rc12. Source and automated contracts prove implementation structure; they do not replace device smoke tests or screenshots.
