...
- API 24 and Android 16 runtime remain unperformed because matching devices/images were unavailable. Deterministic fixture insertion does not claim hands-on third-party bind approval, Launcher recreation restoration, real configuration cancellation, orientation persistence, movement, deletion, or resize validation.
