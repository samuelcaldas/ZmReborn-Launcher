...
public class ApplicationsAdapter extends ArrayAdapter<ApplicationItemInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CharSequence contentDescription = buildApplicationDescription(context, applicationItemInfo);
    ...
    private CharSequence buildApplicationDescription(Context context, ApplicationItemInfo info) {
        if (this.mUninstalling && !Utilities.canUninstallApplication(context, info)) {
            return info.title;
        }
        return info.title;
    }
