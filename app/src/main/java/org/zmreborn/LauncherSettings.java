...
class LauncherSettings {
    ...
    static final class AppListFolders {
        ...
        static final Uri ITEMS_CONTENT_URI = Uri.parse(CONTENT_URI_PREFIX + "appListFolderItems?notify=true");
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        static final Uri CONTENT_URI = Uri.parse(CONTENT_URI_PREFIX + "favorites?notify=true");
        static final Uri CONTENT_URI_NO_NOTIFICATION = Uri.parse(CONTENT_URI_PREFIX + "favorites?notify=false");
        ...
        static Uri getContentUri(long id, boolean notify) {
            return Uri.parse(CONTENT_URI_PREFIX + "favorites/" + id + "?notify=" + notify);
        }
    }
}
